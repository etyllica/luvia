...
public class Boundary extends Ponto3D{

	protected List<Ponto3D> points = new ArrayList<Ponto3D>(); // Points making up the boundary
	...
	public void add(double x, double y, double z){
		add(new Ponto3D(x, y, z));
	}
	
	public void add(Ponto3D ponto){
		points.add(ponto);		
	}
	...
	public List<Ponto3D> getPoints() {
		return points;
	}
	
	public void setPoints(List<Ponto3D> points) {
		this.points = points;
	}
