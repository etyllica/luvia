...
public class Poligono3D extends Ponto3D{
	
	protected float anguloX;
	protected float anguloY;
	protected float anguloZ;
		
	protected Vector<Ponto3D> vertices;
	
	public Poligono3D(){
		this(0,0,0);
	}
	public Poligono3D(double x, double y, double z){
		super(x,y,z);
		
		vertices = new Vector<Ponto3D>();
	...
	public Vector<Ponto3D> getVertices(){
		return vertices;
	}
